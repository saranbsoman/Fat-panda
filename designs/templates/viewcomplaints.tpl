                ...
                <header class="nav_w3pvt text-center">
                    ...
                    <nav class="wthree-w3ls">
                        ...
                        <ul class="menu mr-auto">
                            {foreach from=$view1 item='b'}<li class="active"><a href="restprofileadmin.php?v={$b.rrkey}">Back</a></li>{/foreach}
                            <!-- <li class="active"><a href="restprofileadmin.php?v={$b.rrkey}">Back</a></li> -->
                            ...
                            <li><a href="viewcomplaints.php?v={$b.rrkey}">Complaint</a></li>   
                            {/foreach}  -->
                        </ul>
                    </nav>
                    <!-- //nav -->
