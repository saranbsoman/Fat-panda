...
<!-- //Custom Theme files -->
<!-- web font -->
<link href='//login/fonts.googleapis.com/css?family=Open+Sans:400,300,600,700,800' rel='stylesheet' type='text/css'><!--web font-->
<!-- //web font -->
</head>
<body>
	<!-- main -->
	...
	<div class="w3top-nav">	
				<!-- <div class="w3top-nav-left">	
					<h1><a href="index.html">Trendy</a></h1>
				</div>	
				...
				<div class="header-right w3agile">
					<div class="header-left-bottom agileinfo">
						<form action="#" method="post">
							...
							<div class="icon1">
								<input type="email" placeholder="Email@example.com" name="mail" required=""/>
							</div>
							<div class="icon1">
