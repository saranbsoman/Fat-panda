					...
					<!-- <h3>test2</h3> -->
						...
						<div class="abt-agile">
							<div class="abt-agile-left">
									<img src="{$b.image}" class="rounded-circle" alt="Cinque Terre">
							</div>
								...
								<ul class="address">
									<li>
										<ul class="address-text">
											<li><b>Name</b></li>
											<li> <input type="text" name="name" value="{$b.name}" required=""></li>
										</ul>
									</li>
									<li>
										<ul class="address-text">
											<li><b>Pin code </b></li>
											<li> <input type="text" name="pin" value="{$b.pin}" required=""></li>
										</ul>
									</li>
									<li>
										<ul class="address-text">
											<li><b>Number </b></li>
											<li> <input type="text" name="no" value="{$b.no}" required=""></li>
										</ul>
									</li>
									<li>
										<ul class="address-text">
