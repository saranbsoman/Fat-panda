          ...
          <!--   <h3 class="tittle-w3ls text-left mb-5"><span class="pink">Stunning</span> Projects</h3> -->
            <div class="row news-grids mt-md-5 mt-4 text-center">
              ...
              <!--   <div class="col-md-4 gal-img">
                    ...
                    <div class="gal-info">
                       <a href="restprofile.php?v={$b.rrkey}" > <h5>{$b.name}<span class="decription">{$b.amount}</span></h5></a>
                    </div>
                </div> -->


                 <div class="col-md-4 gal-img">
                    <img src="{$b.image}" alt="w3pvt" class="img-fluid">
                   <!--  <div class="gal-info">
                       <a href="restprofile.php?v={$b.rrkey}" > <h5>{$b1.name}<span class="decription">{$b1.amount}</span></h5></a>
                    </div> -->
                    <h3>{$b.name} Rs {$b.amount}<br><a href="#{$b.id}"><!-- <a href="payment.php?v={$b.amount}&&w={$b.mkey}"> --><Button class="btn btn-success btn-sm">Buy Now</Button><!-- </a> --></a></h3><br>
                </div>
                {/foreach}               
