...
<head>
    ...
    <!-- //Meta tag Keywords -->
    <!-- Custom-Files -->
    <link rel="stylesheet" href="rest/css/bootstrap.css">
    <!-- Bootstrap-Core-CSS -->
    <link rel="stylesheet" href="rest/css/style.css" type="text/css" media="all" />
    <!-- Style-CSS -->
    <!-- font-awesome-icons -->
    <link href="rest/css/font-awesome.css" rel="stylesheet">
    <!-- //font-awesome-icons -->
    <!-- /Fonts -->
    ...
    <div class="main-banner" id="home">
        ...
        <div class="banner-info">
            <div class="w3pvt-logo text-center">
                <h1> <a href="index.php">Unrivaled</a></h1>
            </div>
