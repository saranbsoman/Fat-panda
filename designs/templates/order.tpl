                ...
                <header class="nav_w3pvt text-center">
                    ...
                    <nav class="wthree-w3ls">
                        ...
                        <ul class="menu mr-auto">
                            ...
                            <li><a href="order.php?v={$b.rrkey}">My Order</a></li>   
                            {/foreach} 
                        </ul>
                    </nav>
                    <!-- //nav -->
            ...
            <div class="row news-grids mt-md-5 mt-4 text-center">
                ...
                <div class="col-md-4 gal-img">
                   ...
                   <!--  <h3>{$b1.name} Rs {$b1.amount}<br><a href="payment.php?v={$b1.amount}&&w={$b1.mkey}"><Button class="btn btn-success btn-sm">Buy Now</Button></a></h3><br> -->
                     <h3>{$b1.name} Rs {$b1.amount}<br><a href="removeorder.php?v={$b1.ckey}"><!-- <a href="payment.php?v={$b.amount}&&w={$b.mkey}"> --><Button class="btn btn-primary btn-sm">Remove</Button><!-- </a> --></a></h3><br>
