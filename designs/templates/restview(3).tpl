...
<!-- Mirrored from eliteadmin.themedesigner.in/demos/bt4/modern/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 14 Jul 2019 06:21:44 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="bt4/assets/images/favicon.png">
    <title>Elite Admin Template - The Ultimate Multipurpose admin template</title>
    <!-- This page CSS -->
    <!-- chartist CSS -->
    <link href="softzaneadmin/bt4/assets/node_modules/morrisjs/morris.css" rel="stylesheet">
    <!--Toaster Popup message CSS -->
    <link href="softzaneadmin/bt4/assets/node_modules/toast-master/css/jquery.toast.css" rel="stylesheet">
    <!-- Custom CSS -->
    <link href="softzaneadmin/bt4/admin/dist/css/style.min.css" rel="stylesheet">
    <!-- Dashboard 1 Page CSS -->
    <link href="softzaneadmin/bt4/admin/dist/css/pages/dashboard1.css" rel="stylesheet">
...
<body class="skin-default fixed-layout">
    ...
    <div class="preloader">
        <div class="loader">
            ...
            <p class="loader__label">Softzane Admin</p>
        </div>
    </div>
    <!-- ============================================================== -->
    ...
    <div id="main-wrapper">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.php">
                        ...
                        <b>
                            ...
                            <!-- Dark Logo icon -->
                            <img src="softzaneadmin/bt4/assets/images/logo-icon.png" alt="homepage" class="dark-logo" />
                            <!-- Light Logo icon -->
                            <img src="softzaneadmin/bt4/assets/images/logo-light-icon.png" alt="homepage" class="light-logo" />
                        </b>
                        <!--End Logo icon -->
                    </a>
                </div>
                    ...
                    <ul class="navbar-nav mr-auto">
                        <li class="d-none d-md-block d-lg-block">
                            <a href="javascript:void(0)" class="p-l-15">
                                <!--This is logo text-->
                                <img src="softzaneadmin/bt4/assets/images/logo-light-text.png" alt="home" class="light-logo" alt="home" />
                            </a>
                        </li>
                    </ul>
                    <!-- ============================================================== -->
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <div class="message-center">
                                            <!-- Message -->
                                            <a href="javascript:void(0)">
                                                <div class="user-img"> <img src="bt4/assets/images/users/1.jpg" alt="user" class="img-circle"> <span class="profile-status online pull-right"></span> </div>
                                                <div class="mail-contnet">
                                                    <h5>Pavan kumar</h5> <span class="mail-desc">Just see the my admin!</span> <span class="time">9:30 AM</span> </div>
                                            </a>
                                            <!-- Message -->
                                            <a href="javascript:void(0)">
                                                <div class="user-img"> <img src="bt4/assets/images/users/2.jpg" alt="user" class="img-circle"> <span class="profile-status busy pull-right"></span> </div>
                                                <div class="mail-contnet">
                                                    <h5>Sonu Nigam</h5> <span class="mail-desc">I've sung a song! See you at</span> <span class="time">9:10 AM</span> </div>
                                            </a>
                                            <!-- Message -->
                                            <a href="javascript:void(0)">
                                                <div class="user-img"> <img src="bt4/assets/images/users/3.jpg" alt="user" class="img-circle"> <span class="profile-status away pull-right"></span> </div>
                                                <div class="mail-contnet">
                                                    <h5>Arijit Sinh</h5> <span class="mail-desc">I am a singer!</span> <span class="time">9:08 AM</span> </div>
                                            </a>
                                            <!-- Message -->
                                            <a href="javascript:void(0)">
                                                <div class="user-img"> <img src="bt4/assets/images/users/4.jpg" alt="user" class="img-circle"> <span class="profile-status offline pull-right"></span> </div>
                                                <div class="mail-contnet">
                                                    <h5>Pavan kumar</h5> <span class="mail-desc">Just see the my admin!</span> <span class="time">9:02 AM</span> </div>
                                            </a>
                                        </div>
        ...
        <div class="side-mini-panel">
            <ul class="mini-nav">
                ...
                <li class=""><a href="javascript:void(0)"><i class="ti-layout-media-right-alt"></i></a>
                    <div class="sidebarmenu">
                        ...
                        <ul class="sidebar-menu">
                            <li><a href="adminaddcollege.php">Add college</a></li>
                            <li><a href="internship.php">Internship</a></li>
                            
                            
                            <li><a href="form.php">Registration Form</a></li>
                            <li><a href="client_details.php">Client Form</a></li>
                            <li><a href="income_details.php">Income Details</a></li>
                            <li><a href="expense_details.php">Expense Details</a></li>
                            <!--
                ...
                <!-- /.Forms -->
                <!-- .Tables -->
                <li class=""><a href="javascript:void(0)"><i class="ti-layout-accordion-merged"></i></a>
                    <div class="sidebarmenu">
                        <!-- Left navbar-header -->
                        <h3 class="menu-title">Registration</h3>
                        <div class="searchable-menu">
                            <form role="search" class="menu-search">
                                <input type="text" placeholder="Search..." class="form-control">
                                <a href="#"><i class="fa fa-search"></i></a>
                        ...
                        <ul class="sidebar-menu">
                            ...
                            <li><a href="viewregisterdetails.php">Registration Details</a></li>
                            <li><a href="viewinternshipdetails.php">Internship Details</a></li>
                            <li><a href="searchcollege.php">Search College</a></li>
                            <li><a href="viewclientdetails.php">Client Details</a></li>
                ...
                <li class=""><a href="javascript:void(0)"><i class="ti-email"></i></a>
                    <div class="sidebarmenu">
                        <!-- Left navbar-header -->
                        <h3 class="menu-title">Fee Details</h3>
                        <div class="searchable-menu">
                            <form role="search" class="menu-search">
                                <input type="text" placeholder="Search..." class="form-control"> <a href="#"><i class="fa fa-search"></i></a> </form>
                        </div>
                        <ul class="sidebar-menu">
                            <li><a href="feedetailsstudent.php">Student Fee</a></li>
                            <li><a href="feedetailsinternship.php">Internship Fee</a></li>
                            <li><a href="feedetailsclient.php">Client Fee</a></li>
                        </ul>
                        <!-- Left navbar-header end -->
                    </div>
                </li>
                ...
                <li class=""><a href="javascript:void(0)"><i class="ti-settings"></i></a>
                    <div class="sidebarmenu">
                        ...
                        <ul class="sidebar-menu">
                            ...
                            <li><a href="yearly_income.php">Annual Income</a></li>
                        </ul>
                        <!-- Left navbar-header end -->
                    </div>
                </li>
                <!-- /.Widgets -->
                <!-- .Page-layout -->
                <li class=""><a href="javascript:void(0)"><i class="ti-gallery"></i></a>
                    <div class="sidebarmenu">
                        <!-- Left navbar-header -->
                        <h3 class="menu-title">Expense</h3>
                        <div class="searchable-menu">
                            <form role="search" class="menu-search">
                                <input type="text" placeholder="Search..." class="form-control">
                                <a href="#"><i class="fa fa-search"></i></a>
                        ...
                        <ul class="sidebar-menu">
                            ...
                            <li><a href="monthly_expense.php">Monthly Expense</a></li>
                            <li><a href="yearly_expense.php">Annual Expense</a></li>
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-12">
                        <h4 class="text-white">Minimal Dashboard</h4>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                            <li class="breadcrumb-item active">Minimal Dashboard</li>
                        </ol>
                    </div>
                            ...
                            <div class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    <div class="active carousel-item">
                                        <div class="overlaybg" style="background:url(bt4/assets/images/news/slide6.jpg) no-repeat center center /cover"></div>
                                        <div class="blogs-content carousel-caption"><span class="label label-danger label-rounded">Primary</span>
                                            <h4>It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</h4> <a href="javascript:void(0)">Read More</a>
                                        </div>
                                    </div>
                                    <div class="carousel-item">
                                        <div class="overlaybg" style="background:url(bt4/assets/images/news/slide6.jpg) no-repeat center center /cover"></div>
                                        <div class="blogs-content carousel-caption"><span class="label label-primary label-rounded">Primary</span>
                                            <h4>It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</h4> <a href="javascript:void(0)">Read More</a>
                                        </div>
                                    </div>
                                    <div class="carousel-item">
                                        <div class="overlaybg" style="background:url(bt4/assets/images/news/slide6.jpg) no-repeat center center /cover"></div>
                                        <div class="blogs-content carousel-caption"><span class="label label-success label-rounded">Primary</span>
                                            <h4>It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</h4> <a href="javascript:void(0)">Read More</a>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="carousel-inner">
                                                <div class="carousel-item active">
                                                    ...
                                                    <div class="d-flex no-block">
                                                        <span><img src="bt4/assets/images/users/1.jpg" alt="user" width="50" class="img-circle"></span>
                                                        <span class="m-l-10">
                                                ...
                                                <div class="carousel-item">
                                                    <h4 class="cmin-height">My Acting blown <span class="font-medium">Your Mind</span> and you also <br/>laugh at the moment</h4>
                                                    <div class="d-flex no-block">
                                                        <span><img src="bt4/assets/images/users/3.jpg" alt="user" width="50" class="img-circle"></span>
                                                        <span class="m-l-10">
                                                    <h4 class="text-white m-b-0">Govinda</h4>
                                                    <p class="text-white">Actor</p>
                                                    </span>
                        ...
                        <div class="card">
                            ...
                            <div class="comment-widgets">
                                ...
                                <div class="d-flex no-block comment-row">
                                    <div class="p-2"><span class="round"><img src="bt4/assets/images/users/1.jpg" alt="user" width="50"></span></div>
                                ...
                                <div class="to-do-widget m-t-20" id="todo" style="height: 400px;position: relative;">
                                    ...
                                    <ul class="list-task todo-list list-group m-b-0" data-role="tasklist">
                                        <li class="list-group-item" data-role="task">
                                            ...
                                            <ul class="assignedto">
                                                <li><img src="bt4/assets/images/users/1.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Steave"></li>
                                                <li><img src="bt4/assets/images/users/2.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Jessica"></li>
                                                <li><img src="bt4/assets/images/users/3.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Priyanka"></li>
                                                <li><img src="bt4/assets/images/users/4.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Selina"></li>
                                            </ul>
                                        </li>
                                        <li class="list-group-item" data-role="task">
                                            <div class="custom-control custom-checkbox">
                            ...
                            <div class="card-body">
                                ...
                                <div class="chat-box" id="chat" style="height: 327px;position: relative;">
                                    ...
                                    <ul class="chat-list">
                                        <!--chat Row -->
                                        <li>
                                            <div class="chat-img"><img src="bt4/assets/images/users/1.jpg" alt="user"></div>
                                        ...
                                        <!--chat Row -->
                                        <li>
                                            <div class="chat-img"><img src="bt4/assets/images/users/2.jpg" alt="user"></div>
                                            <div class="chat-content">
                                                <h5>Bianca Doe</h5>
                                        ...
                                        <!--chat Row -->
                                        <li>
                                            <div class="chat-img"><img src="bt4/assets/images/users/3.jpg" alt="user"></div>
                                            <div class="chat-content">
                    ...
                    <div class="slimscrollright">
                        ...
                        <div class="r-panel-body">
                            <ul class="m-t-20 chatonline">
                                <li>
                                    <a href="javascript:void(0)"><img src="bt4/assets/images/users/1.jpg" alt="user-img" class="img-circle"> <span>Varun Dhavan <small class="text-success">online</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img src="bt4/assets/images/users/2.jpg" alt="user-img" class="img-circle"> <span>Genelia Deshmukh <small class="text-warning">Away</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img src="bt4/assets/images/users/3.jpg" alt="user-img" class="img-circle"> <span>Ritesh Deshmukh <small class="text-danger">Busy</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img src="bt4/assets/images/users/4.jpg" alt="user-img" class="img-circle"> <span>Arijit Sinh <small class="text-muted">Offline</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img src="bt4/assets/images/users/5.jpg" alt="user-img" class="img-circle"> <span>Govinda Star <small class="text-success">online</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img src="bt4/assets/images/users/6.jpg" alt="user-img" class="img-circle"> <span>John Abraham<small class="text-success">online</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img src="bt4/assets/images/users/7.jpg" alt="user-img" class="img-circle"> <span>Hritik Roshan<small class="text-success">online</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img src="bt4/assets/images/users/8.jpg" alt="user-img" class="img-circle"> <span>Pwandeep rajan <small class="text-success">online</small></span></a>
                                </li>
                            </ul>
                        </div>
                    </div>
    ...
    <!-- All Jquery -->
    <!-- ============================================================== -->
    <script src="softzaneadmin/bt4/assets/node_modules/jquery/jquery-3.2.1.min.js"></script>
    <!-- Bootstrap popper Core JavaScript -->
    <script src="softzaneadmin/bt4/assets/node_modules/popper/popper.min.js"></script>
    <script src="softzaneadmin/bt4/assets/node_modules/bootstrap/dist/js/bootstrap.min.js"></script>
    <!-- slimscrollbar scrollbar JavaScript -->
    <script src="softzaneadmin/bt4/admin/dist/js/perfect-scrollbar.jquery.min.js"></script>
    <!--Wave Effects -->
    <script src="softzaneadmin/bt4/admin/dist/js/waves.js"></script>
    <!--Menu sidebar -->
    <script src="softzaneadmin/bt4/admin/dist/js/sidebarmenu.js"></script>
    <!--Custom JavaScript -->
    <script src="softzaneadmin/bt4/admin/dist/js/custom.min.js"></script>
    <!-- ============================================================== -->
    <!-- This page plugins -->
    <!-- ============================================================== -->
    <!--morris JavaScript -->
    <script src="softzaneadmin/bt4/assets/node_modules/raphael/raphael-min.js"></script>
    <script src="softzaneadmin/bt4/assets/node_modules/morrisjs/morris.min.js"></script>
    <script src="softzaneadmin/bt4/assets/node_modules/jquery-sparkline/jquery.sparkline.min.js"></script>
    <!-- Popup message jquery -->
    <script src="softzaneadmin/bt4/assets/node_modules/toast-master/js/jquery.toast.js"></script>
    <!-- Chart JS -->
    <script src="softzaneadmin/bt4/admin/dist/js/dashboard1.js"></script>
    <script>
...
<!-- Mirrored from eliteadmin.themedesigner.in/demos/bt4/modern/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 14 Jul 2019 06:27:50 GMT -->
</html>