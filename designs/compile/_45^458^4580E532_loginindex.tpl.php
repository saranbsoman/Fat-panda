<?php /* Smarty version 2.6.26, created on 2020-01-12 04:56:49
         compiled from loginindex.tpl */ ?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="card-body">
                ...
                <form method="post" class="form-horizontal form-material text-center" id="loginform" action="">
                    ...
                    <div class="form-group m-t-40">
                        <div class="col-xs-12">
                            <input class="form-control" name="mail" type="text" required="" placeholder="Username">
                        </div>
                    </div>
