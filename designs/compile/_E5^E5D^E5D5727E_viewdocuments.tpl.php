<?php /* Smarty version 2.6.26, created on 2020-01-28 16:20:36
         compiled from viewdocuments.tpl */ ?>
<!--
Author: W3layouts
...
?><li class="active"><a href="restprofileadmin.php?v=<?php echo $this->_tpl_vars['b']['rrkey']; ?>
">Back</a></li><?php endforeach; endif; unset($_from); ?>
...
?>
                        <a class="slideanim" href="<?php echo $this->_tpl_vars['b1']['path']; ?>
" target="_blank"/><Button class="btn btn-primary btn-sm">Download</Button></a>
                        <a class="slideanim" href="<?php echo $this->_tpl_vars['b1']['path1']; ?>
" target="_blank"/><Button class="btn btn-primary btn-sm">Download</Button></a>
                        <a class="slideanim" href="<?php echo $this->_tpl_vars['b1']['path2']; ?>
" target="_blank"/><Button class="btn btn-primary btn-sm">Download</Button></a>
                        <a class="slideanim" href="<?php echo $this->_tpl_vars['b1']['path3']; ?>
" target="_blank"/><Button class="btn btn-primary btn-sm">Download</Button></a>
                        <a class="slideanim" href="<?php echo $this->_tpl_vars['b1']['path4']; ?>
" target="_blank"/><Button class="btn btn-primary btn-sm">Download</Button></a>
                        <?php endforeach; endif; unset($_from); ?>
  <!--       </div> 
