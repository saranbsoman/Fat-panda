<?php /* Smarty version 2.6.26, created on 2020-01-28 17:27:15
...
<body>
		...
		<div class="container d-lg-flex justify-content-between align-items-center">
			...
			<h1 class="logo-style-res float-left">
				<a class="navbar-brand" href="index.php">
					<img src="web/images/logo.png" alt="" class="img-fluid logo-img mt-1" width="50px" height="50px"><h1:3px> Fat Panda</h1>
				</a>
			</h1>
			<!-- //logo -->
			<!-- nav -->
				...
				<nav>
					...
					<ul class="menu mx-lg-auto">
						...
						<!-- <li>
							...
							<ul>
								<li><a href="restreg.php" class="drop-text">Restaurant\'s</a></li>
								<li><a href="userreg.php" class="drop-text">Customer</a></li>
								<li><a href="staffreg.php" class="drop-text">Staff</a></li>
			...
			<div class="text-center">
				<a href="loginindex.php" class="login-button-2 text-uppercase text-wh mt-lg-0 mt-2">Login </a>
			</div>
			<!-- //dwn -->
		</div>
	</div>
			...
			<div class="row">
				<div class="col-lg-4 about-in text-center">
					<div class="serv-cont-wthree">
						...
						<h5 class="card-title mb-3 mt-4"><a href="restreg.php" class="drop-text">Register your Restaurant</a></h5>
				...
				<div class="col-lg-4 about-in text-center my-lg-0 my-4">
					<div class="serv-cont-wthree">
						...
						<h5 class="card-title mb-3 mt-4"><a href="userreg.php" class="drop-text">New User</a></h5>
						<!-- <p class="card-text">Lorem ipsum dolor sit amet consectetur elit,Adipisicing elit
							tempor.</p> -->
					</div>
				</div>
				<div class="col-lg-4 about-in text-center">
					<div class="serv-cont-wthree">
						...
						<h5 class="card-title mb-3 mt-4"><a href="loginindex.php" class="drop-text">Sign in as Restaurant</a></h5>
						<!-- <p class="card-text">Lorem ipsum dolor sit amet consectetur elit,Adipisicing elit
							tempor.</p> -->
					</div>
				</div>
	...
	<section class="w3ls-bnrbtm py-5" id="about">
		<div class="container py-xl-5 py-lg-3">
			<div class="row pb-5">
				<div class="col-lg-6">
					<img class="img-fluid" src="web/images/ab.jpg" alt="">
				</div>
				<div class="col-lg-6 pl-lg-5 abou-right-w3layuts mt-lg-0 mt-5">
					<h3 class="mb-4">Welcome to Our Baking <br>Website</h3>
			...
			<div class="row flex-row-reverse border-top pt-lg-5 pt-sm-4 pt-2 mt-lg-5 mt-sm-4 mt-2">
				<div class="col-lg-6">
					<img class="img-fluid mt-5" src="web/images/ab2.jpg" alt="">
				</div>
				<div class="col-lg-6 abou-right-w3layuts mt-5">
					<h3 class="mb-4">Title text goes here in one or <br>two lines</h3>
					<p>Donec consequat sapien ut leo cursus rhoncus. Nullam dui mi, vulputate ac metus
						at, semper
						varius orci. </p>
					<p>Nulla accumsan ac elit in congue. Class aptent taciti sociosqu ad litora torquent
	...
	<section class="teams py-5" id="chefs">
		<div class="container py-xl-5 py-lg-3">
			...
			<div class="row text-center">
				<div class="col-lg-4">
					<div class="team-gd">
						<img src="web/images/t1.jpg" class="img-fluid" alt="user-image">
				...
				<div class="col-lg-4 mt-lg-0 mt-5">
					<div class="team-gd">
						<img src="web/images/t2.jpg" class="img-fluid" alt="user-image">
						<div class="team-info mt-4">
				...
				<div class="col-lg-4 mt-lg-0 mt-5">
					<div class="team-gd">
						<img src="web/images/t3.jpg" class="img-fluid" alt="user-image">
						<div class="team-info mt-4">
			...
			<div class="row"> -->
				...
				<!-- <div class="col-lg-4 col-md-6 px-md-2">
					<div class="card">
						<div class="card-header p-0 position-relative">
							<a href="#">
								<img class="card-img-bottom" src="web/images/blog1.jpg" alt="Card image cap">
						...
						<div class="card-body">
							...
							<div class="row mt-5">
								<div class="col-3 testi-img-res px-2">
									<img src="web/images/te1.jpg" alt=" " class="img-fluid rounded-circle" />
								</div>
				...
				<!-- <div class="col-lg-4 col-md-6 px-md-2 mt-md-0 mt-5">
					<div class="card">
						<div class="card-header p-0 position-relative">
							<a href="#">
								<img class="card-img-bottom" src="web/images/blog2.jpg" alt="Card image cap">
								<span class="fa fa-user post-icon"></span>
							</a>
						</div>
						<div class="card-body">
							...
							<div class="row mt-5">
								<div class="col-3 testi-img-res px-2">
									<img src="web/images/te2.jpg" alt=" " class="img-fluid rounded-circle" />
								</div>
								<div class="col-9 w3_testi_grid mt-xl-2 mt-lg-0 mt-md-2 mt-4">
				...
				<!-- <div class="col-lg-4 col-md-6 px-md-2 mt-lg-0 mt-5">
					<div class="card">
						<div class="card-header p-0 position-relative">
							<a href="#">
								<img class="card-img-bottom" src="web/images/blog3.jpg" alt="Card image cap">
								<span class="fa fa-user post-icon"></span>
							</a>
						</div>
						<div class="card-body">
							...
							<div class="row mt-5">
								<div class="col-3 testi-img-res px-2">
									<img src="web/images/te3.jpg" alt=" " class="img-fluid rounded-circle" />
								</div>
								<div class="col-9 w3_testi_grid mt-xl-2 mt-lg-0 mt-md-2 mt-4">
			...
			<div class="row no-gutters">
				<div class="col-md-4 gallery-grid1">
					<a href="#gal1">
						...
						<img src="web/images/g1.jpg" alt=" " class="img-fluid" />
					</a>
				</div>
				<div class="col-md-4 gallery-grid1">
					<a href="#gal2">
						<img src="web/images/g2.jpg" alt=" " class="img-fluid" />
					</a>
				</div>
				<div class="col-md-4 gallery-grid1">
					<a href="#gal3">
						<img src="web/images/g3.jpg" alt=" " class="img-fluid" />
					</a>
				</div>
			</div>
			<div class="row no-gutters">
				<div class="col-md-4 gallery-grid1">
					<a href="#gal4">
						<img src="web/images/g4.jpg" alt=" " class="img-fluid" />
					</a>
				</div>
				<div class="col-md-4 gallery-grid1">
					<a href="#gal5">
						<img src="web/images/g5.jpg" alt=" " class="img-fluid" />
					</a>
				</div>
				<div class="col-md-4 gallery-grid1">
					<a href="#gal6">
						<img src="web/images/g6.jpg" alt=" " class="img-fluid" />
					</a>
				</div>
			</div>
		</div>
				...
				<div class="row footer-grids pt-lg-3 pb-4">
					<div class="col-lg-4 footer-grid">
						<div class="footer-logo">
							<h2>
								<a class="logo mt-md-5 mt-1" href="index.php">Fat Panda</a>
							</h2>
						</div>
					</div>
