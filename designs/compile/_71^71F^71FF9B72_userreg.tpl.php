<?php /* Smarty version 2.6.26, created on 2020-01-02 08:33:33
...
<table>
	...
	<tr><td>Add Profile Picture</td><td><input type="file" name="img"></td></tr>				
		...
		<div class="main">
			<h1 class="w3layouts_head"><!-- Event  -->Registration Form</h1>
				...
				<div class="w3layouts_main_grid">
					<form method="post" action="" enctype="multipart/form-data" class="w3_form_post">
						<input type="hidden" name="hide" value="h">
