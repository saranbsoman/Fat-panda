<?php /* Smarty version 2.6.26, created on 2020-02-07 07:54:00
         compiled from restaccountedit.tpl */ ?>
<!DOCTYPE html>
<html lang="en">
    ...
    <section><br><br><br><br><br><br>
        <div class="login-box card">
            <div class="card-body">
               ...
               <a href="restaccount.php"><font color=red></i></font><font color="red"><button class="btn btn-outline-dark btn-sm">Back</button></font></a></font>
<!-- <h3>test1</h3> --><center>
...
" class="rounded-circle" alt="Cinque Terre" height="180px" width="180px">
                            ...
                            <div class="abt-agile-left"><br>
                                ...
                                <!-- <h3>test2</h3> -->
                                          ...
                                          <tr>  <td><b>Name </b></td><td><input type="text" name="name" value="<?php echo $this->_tpl_vars['b']['restname']; ?>
" required="" class="form-control"></td></tr>
                                            
                                            
                                          <tr>  <td>   <b>Address </b></td><td><input type="text" name="add" value="<?php echo $this->_tpl_vars['b']['address']; ?>
" required="" class="form-control"></td></tr>
                                       
                                         <tr>  <td>    <b>Pin code </b></td><td><input type="text" name="pin" value="<?php echo $this->_tpl_vars['b']['pincode']; ?>
" required="" class="form-control"></td></tr>
                                        ...
                                        <tr>  <td>     <b>City </b></td><td><input type="text" name="city" value="<?php echo $this->_tpl_vars['b']['city']; ?>
"  required="" class="form-control"></td></tr>

                                        <tr>  <td>     <b>Contact no </b></td><td><input type="text" name="cno" value="<?php echo $this->_tpl_vars['b']['contactno']; ?>
"  required="" class="form-control"></td></tr>

                                        <tr>  <td>     <b>Reservation </b></td><td><input type="text" name="reser" value="<?php echo $this->_tpl_vars['b']['reservation']; ?>
"  required="" class="form-control"></td></tr>

                                        <tr>  <td>     <b>Seats </b></td><td><input type="text" name="seat" value="<?php echo $this->_tpl_vars['b']['seats']; ?>
"  required="" class="form-control"></td></tr>

                                        <tr>  <td>     <b>Parking </b></td><td><input type="text" name="park" value="<?php echo $this->_tpl_vars['b']['parking']; ?>
"  required="" class="form-control"></td></tr>


                                        <tr>  <td>     <b>Profile Picture </b></td><td><input type="file" name="img" value="<?php echo $this->_tpl_vars['b']['image']; ?>
"  required="" class="form-control"></td></tr>
