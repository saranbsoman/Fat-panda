<?php /* Smarty version 2.6.26, created on 2020-01-28 18:10:48
         compiled from restgallery.tpl */ ?>
<!--  <?php echo '
    <script>
                ...
                <nav class="py-2 d-lg-flex">
                    ...
                    <ul class="menu ml-auto">
                       ...
                       <!--  <li ><a href="adminrequest.php">Requests <span class="badge"><h6><font color="red">(<?php echo $this->_tpl_vars['count']; ?>
                        ...
                        <li><?php $_from = $this->_tpl_vars['view1']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
<section><?php $_from = $this->_tpl_vars['view']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['b']):
?>
            ...
            <div class="row no-gutters">
                <div class="col-md-4 gallery-grid1">
                    <a href="#gal1">
                        ...
                        <img src="<?php echo $this->_tpl_vars['b']['path']; ?>
" alt=" " class="img-fluid" />
                    </a>
                </div>
        ...
        <div id="gal1" class="pop-overlay animate">
            <div class="popup">
                <img src="<?php echo $this->_tpl_vars['b']['path1']; ?>
