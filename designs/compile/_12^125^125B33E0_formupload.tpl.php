<?php /* Smarty version 2.6.26, created on 2019-12-21 06:45:57
         compiled from formupload.tpl */ ?>
<!DOCTYPE html>
<html lang="en">


<!-- Mirrored from eliteadmin.themedesigner.in/demos/bt4/modern/form-upload.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 14 Jul 2019 06:30:49 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="bt4/assets/node_modules/dropify/dist/css/dropify.min.css">
    <!-- Custom CSS -->
    <link href="bt4/admin/dist/css/style.min.css" rel="stylesheet">
...
<body class="skin-default fixed-layout">
    ...
    <div id="main-wrapper">
        ...
        <div class="side-mini-panel">
            <ul class="mini-nav">
                ...
                <!-- /.Dashboard -->
                <!-- .Apps -->
                <li class=""><a href="javascript:void(0)"><i class="ti-layout-grid2"></i></a>
                    <div class="sidebarmenu">
                        <!-- Left navbar-header -->
                ...
                <!-- /.Inbox -->
                <!-- .Ui Elemtns -->
                <li><a href="javascript:void(0)"><i class="ti-palette"></i></a>
                    <div class="sidebarmenu">
                        <!-- Left navbar-header -->
                ...
                <li class=""><a href="javascript:void(0)"><i class="ti-gallery"></i></a>
                    <div class="sidebarmenu">
                        <!-- Left navbar-header -->
                        <h3 class="menu-title">Page Layout</h3>
                        <div class="searchable-menu">
                            <form role="search" class="menu-search">
                                <input type="text" placeholder="Search..." class="form-control">
                                <a href="#"><i class="fa fa-search"></i></a>
                ...
                <!-- /.Page-layout -->
                <!-- .Sample Pages -->
                <li class=""><a href="javascript:void(0)"><i class="ti-files"></i></a>
                    <div class="sidebarmenu">
                        <!-- Left navbar-header -->
                        ...
                        <ul class="sidebar-menu">
                            ...
                            <li><a href="javascript:void(0)">Authentication <span class="badge badge-pill badge-success pull-right">6</span></a>
                                <ul class="sub-menu">
                            ...
                            <li><a href="javascript:void(0)">Error Pages <span class="badge badge-pill badge-success pull-right">5</span></a>
                                <ul class="sub-menu">
                ...
                <!-- /.Sample Pages -->
                <!-- .Charts -->
                <li class=""><a href="javascript:void(0)"><i class="ti-pie-chart"></i></a>
                    <div class="sidebarmenu">
                        <!-- Left navbar-header -->
                ...
                <!-- /.Charts -->
                <!-- .Icons -->
                <li class=""><a href="javascript:void(0)"><i class="ti-light-bulb"></i></a>
                    <div class="sidebarmenu">
                        <!-- Left navbar-header -->
                ...
                <!-- /.Icons -->
                <!-- .Maps -->
                <li class=""><a href="javascript:void(0)"><i class="ti-location-pin"></i></a>
                    <div class="sidebarmenu">
                        <!-- Left navbar-header -->
                ...
                <!-- /.Maps -->
                <!-- .Multi level -->
                <li class=""><a href="javascript:void(0)"><i class="ti-align-left"></i></a>
                    <div class="sidebarmenu">
                        <!-- Left navbar-header -->
                        ...
                        <ul class="sidebar-menu">
                            <li class="menu">
                                <a href="javascript:void(0)">Dropdown level<i class="fa fa-angle-left float-right"></i></a>
                                <!-- .Second level -->
                                <ul class="sub-menu">
                                    <li><a href="javascript:void(0)">item 1.1</a></li>
                                    <li><a href="javascript:void(0)">item 1.2</a></li>
                                    <li> <a class="has-arrow" href="javascript:void(0)" aria-expanded="false">Menu 1.3 <i class="fa fa-angle-left float-right"></i></a>
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-12">
                        <h4 class="text-white">Form Uploads</h4>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                    ...
                    <div class="col-md-6 text-right">
                        <form class="app-search d-none d-md-block d-lg-block" method="post" action="" enctype="multipart/form-data">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <label for="input-file-now-custom-3">You can combine options</label>
                                 <input type="file" name="image4" id="input-file-now" class="dropify" />
                                <!-- <input type="file" id="input-file-now-custom-1" class="dropify" data-default-file="../assets/node_modules/dropify/src/images/test-image-1.jpg" /> -->
                            </div>
                        </div>
                    </div>
              ...
              <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <label for="input-file-now-custom-2">You can set the height</label>
                                 <input type="file" name="image5" id="input-file-now" class="dropify" />
                               <!-- <input type="file" id="input-file-now-custom-1" class="dropify" data-default-file="../assets/node_modules/dropify/src/images/test-image-1.jpg" /> -->
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <label for="input-file-now-custom-3">You can combine options</label>
                                 <input type="file" name="image6" id="input-file-now" class="dropify" />
                                <!-- <input type="file" id="input-file-now-custom-1" class="dropify" data-default-file="../assets/node_modules/dropify/src/images/test-image-1.jpg" /> -->
                            </div>
                        </div>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">File Upload7</h4>
                                <label for="input-file-now-custom-2">You can set the height</label>
                                 <input type="file" name="image7" id="input-file-now" class="dropify" />
                               <!-- <input type="file" id="input-file-now-custom-1" class="dropify" data-default-file="../assets/node_modules/dropify/src/images/test-image-1.jpg" /> -->
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">File Upload8</h4>
                                <label for="input-file-now-custom-3">You can combine options</label>
                                 <input type="file" name="image8" id="input-file-now" class="dropify" />
                                <!-- <input type="file" id="input-file-now-custom-1" class="dropify" data-default-file="../assets/node_modules/dropify/src/images/test-image-1.jpg" /> -->
                            </div>
                        </div>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">File Upload9</h4>
                                <label for="input-file-now-custom-2">You can set the height</label>
                                 <input type="file" name="image9" id="input-file-now" class="dropify" />
                               <!-- <input type="file" id="input-file-now-custom-1" class="dropify" data-default-file="../assets/node_modules/dropify/src/images/test-image-1.jpg" /> -->
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">File Upload10</h4>
                                <label for="input-file-now-custom-3">You can combine options</label>
                                 <input type="file" name="image10" id="input-file-now" class="dropify" />
                                <!-- <input type="file" id="input-file-now-custom-1" class="dropify" data-default-file="../assets/node_modules/dropify/src/images/test-image-1.jpg" /> -->
                            </div>
                        </div>
                    </div>
    ...
    <!-- All Jquery -->
    <!-- ============================================================== -->
    <script src="bt4/assets/node_modules/jquery/jquery-3.2.1.min.js"></script>
    <!-- Bootstrap tether Core JavaScript -->
    <script src="bt4/assets/node_modules/popper/popper.min.js"></script>
    <script src="bt4/assets/node_modules/bootstrap/dist/js/bootstrap.min.js"></script>
    <!-- slimscrollbar scrollbar JavaScript -->
    <script src="bt4/admin/dist/js/perfect-scrollbar.jquery.min.js"></script>
    <!--Wave Effects -->
    <script src="bt4/admin/dist/js/waves.js"></script>
    <!--Menu sidebar -->
    <script src="bt4/admin/dist/js/sidebarmenu.js"></script>
    <!--stickey kit -->
    <script src="bt4/assets/node_modules/sticky-kit-master/dist/sticky-kit.min.js"></script>
    <script src="bt4/assets/node_modules/sparkline/jquery.sparkline.min.js"></script>
    <!--Custom JavaScript -->
    <script src="bt4/admin/dist/js/custom.min.js"></script>
    <!-- ============================================================== -->
    <!-- Plugins for this page -->
    <!-- ============================================================== -->
    <!-- jQuery file upload -->
    <script src="bt4/assets/node_modules/dropify/dist/js/dropify.min.js"></script>
    <script>
...
<!-- Mirrored from eliteadmin.themedesigner.in/demos/bt4/modern/form-upload.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 14 Jul 2019 06:30:50 GMT -->
</html>