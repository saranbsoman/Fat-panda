<?php /* Smarty version 2.6.26, created on 2020-01-09 09:22:40
										...
										<div class="payment-info">
											...
											<form method="POST" action="">
												...
												<div class="tab-for">				
													...
													<h5>CARD NUMBER</h5>													
														<input class="pay-logo" type="text" value="0000-0000-0000-0000" name="cno" onfocus="this.value = \'\';" onblur="if (this.value == \'\') {this.value = \'0000-0000-0000-0000\';}" required="">
												</div>	
												<div class="transaction">
													<div class="tab-form-left user-form">
														<h5>EXPIRATION</h5>
															<ul>
																<li>
																	<input type="number" class="text_box" type="text" name="m" value="6" min="1" />	
																</li>
																<li>
																	<input type="number" class="text_box" type="text" name="y" value="2013" min="1" />	
																</li>
