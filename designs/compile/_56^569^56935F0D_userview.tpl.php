<?php /* Smarty version 2.6.26, created on 2020-02-08 06:46:46
                    ...
                    <nav class="wthree-w3ls">
                        ...
                        <ul class="menu mr-auto">
                            ...
                            <li>
                                ...
                                <li><?php $_from = $this->_tpl_vars['view2']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['b']):
?><a href="order.php?w=<?php echo $this->_tpl_vars['b']['rrkey']; ?>
">My Order</a><?php endforeach; endif; unset($_from); ?></li>  
                             <li><?php $_from = $this->_tpl_vars['view3']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['b']):
?><a href="userprofile.php" class="drop-text">My Account</a><img src="<?php echo $this->_tpl_vars['b']['image']; ?>
" alt=""  class="rounded-circle" alt="Cinque Terre" width="50px" height="50px"><?php echo $this->_tpl_vars['b']['restname']; ?>
...
<span class="decription"><?php echo $this->_tpl_vars['b']['district']; ?>
</span></h5></a>
                    </div>
                </div>
