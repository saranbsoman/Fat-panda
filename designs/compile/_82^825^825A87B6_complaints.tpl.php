<?php /* Smarty version 2.6.26, created on 2020-01-17 11:54:36
         compiled from complaints.tpl */ ?>
...
<center><h1>
    Register Complaint</h1></center>

  
		<form method="post" action="">
			<input type="hidden" name="hide" value="h">
			<textarea name="comp" value="write your complaint" class="form-control"></textarea>
