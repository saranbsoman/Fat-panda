<?php /* Smarty version 2.6.26, created on 2020-01-19 08:11:28
         compiled from restaccount.tpl */ ?>
<!DOCTYPE html>
<html lang="en">
   ...
   <!--  <section id="wrapper" class="login-register login-sidebar" style="background-image:url(panel/bt4/admin/assets/images/background/login-register.jpg);"> -->
    <section><br><br><br><br><br><br>
        <div class="login-box card">
            <div class="card-body">
               <center> <a href="restview.php"><button><font color=red><span>Home</span></font></button></a>
                        <a href="restaccountedit.php"><Button><font color=green><span>Edit Profile</span></font></Button></a></font>
...
" class="rounded-circle" alt="Cinque Terre" height="180px" width="180px">
                            ...
                            <div class="abt-agile-right">
                                ...
                                <h3></h3>
                                            ...
                                            <b>Name </b>: <?php echo $this->_tpl_vars['b']['restname']; ?>
<br>
...
<br>
                                           ...
                                           <b>Pin code </b>: <?php echo $this->_tpl_vars['b']['pincode']; ?>
<br>

                                        
                                 
                                           <b>District </b>: <?php echo $this->_tpl_vars['b']['district']; ?>
<br>

                                        
                                           <b>City </b>: <?php echo $this->_tpl_vars['b']['city']; ?>
<br>

                                        
                                 
                                           <b>Contact no </b>: <?php echo $this->_tpl_vars['b']['contactno']; ?>
<br>

                                        
                                 
                                           <b>Reservation </b>: <?php echo $this->_tpl_vars['b']['reservation']; ?>
<br>

                                        
                                 
                                           <b>Seats </b>: <?php echo $this->_tpl_vars['b']['seats']; ?>
<br>

                                        
                                 
                                           <b>Parking </b>: <?php echo $this->_tpl_vars['b']['parking']; ?>
<br>
