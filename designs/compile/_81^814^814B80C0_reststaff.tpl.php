<?php /* Smarty version 2.6.26, created on 2020-01-28 18:10:03
         compiled from reststaff.tpl */ ?>
<!--  <?php echo '
    <script>
...
<section>
    ...
    <div class="row news-grids mt-md-5 mt-4 text-center">
        ...
        <a href="staffreg.php"><Button class="btn btn-primary">New Staff</Button></a>
        <table border="2" class="table" cellspacing="0">
        <div class="table-users">
            <tr><th>Picture</th><th>Name</th><th>Address</th><th>Number</th><th>Gender</th><th>Age</th></tr>
...
" alt=""  class="rounded-circle" alt="Cinque Terre" width="40px" height="40px"></td>
                ...
                <td><?php echo $this->_tpl_vars['b']['no']; ?>
</td>
