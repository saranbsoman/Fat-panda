<?php /* Smarty version 2.6.26, created on 2020-02-07 08:33:21
         compiled from restprofile.tpl */ ?>
<!--
Author: W3layouts
...
"><Button class="btn btn-success btn-sm">Buy Now</Button></a></h3><br> -->
                     <h3><?php echo $this->_tpl_vars['b1']['name']; ?>
 Rs <?php echo $this->_tpl_vars['b1']['amount']; ?>
<br><a href="#<?php echo $this->_tpl_vars['b1']['id']; ?>
...
" class="pop-overlay">
                <center><h1>hllo<?php echo $this->_tpl_vars['b1']['id']; ?>
</h1>
                <div class="popup">
                    <img src="<?php echo $this->_tpl_vars['b1']['image']; ?>
" alt="w3pvt" class="img-fluid">
                    <form method="post" action="">
                        ...
                        <input type="hidden" name="mkey" value="<?php echo $this->_tpl_vars['b1']['mkey']; ?>
">
                   ...
                   <!--  <h3><?php echo $this->_tpl_vars['b1']['name']; ?>
 Rs <?php echo $this->_tpl_vars['b1']['amount']; ?>
<br><a href="order.php?v=<?php echo $this->_tpl_vars['b1']['amount']; ?>
&&w=<?php echo $this->_tpl_vars['b1']['mkey']; ?>
"><Button class="btn btn-success btn-sm">Buy Now</Button></a></h3><br> -->
