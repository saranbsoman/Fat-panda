<?php /* Smarty version 2.6.26, created on 2020-02-07 07:57:37
         compiled from staffaccountedit.tpl */ ?>
<!DOCTYPE html>
<html lang="en">
    ...
    <section><br><br><br><br><br><br>
        <div class="login-box card">
            <div class="card-body">
               ...
               <a href="staffaccount.php"><font color=red><button class="btn btn-outline-dark btn-sm">Back</button></a></font>
<!-- <h3>test1</h3> --><center>
...
" required="" class="form-control"></td></tr>
                                          ...
                                          <tr>  <td>   <b>Address </b></td><td><input type="text" name="pin" value="<?php echo $this->_tpl_vars['b']['address']; ?>
" required="" class="form-control"></td></tr>
